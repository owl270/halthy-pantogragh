            ...
            <PantoModals>
                <Modal
                    ...
                    <div className='form-group add-user-form'>
                        ...
                        <div className='input-row'>
                            ...
                            <div className='filter-input-focus-location'>
                                <PantoSelectList
                                    ...
                                    onOpen={() => {
                                        setFocused('location_list');
                                    }}
                                    onClose={() => {
                                        setBlurred('location_list');
                                    }}
                        ...
                        <PantoButton onClick={this.cancel}>okay</PantoButton>
                        <PantoButton onClick={this.okay}>cancel</PantoButton>
